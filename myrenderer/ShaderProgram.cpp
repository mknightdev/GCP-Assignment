...
namespace myrenderer
{
	...
	void ShaderProgram::setVec3(const std::string& _name, const glm::vec3& _value) const
	{
		...
		if (glGetUniformLocation(programID, _name.c_str()) == -1) { throw std::exception("ShaderProgram::setVec3, vec3: Uniform location is -1"); }
	}
	...
	void ShaderProgram::setVec3(const std::string& _name, float _x, float _y, float _z) const
	{
		...
		if (glGetUniformLocation(programID, _name.c_str()) == -1) { throw std::exception("ShaderProgram::setVec3, float: Uniform location is -1"); }
	}
	...
	void ShaderProgram::setFloat(const std::string& _name, float _value) const
	{
		...
		if (glGetUniformLocation(programID, _name.c_str()) == -1) { throw std::exception("ShaderProgram::setFloat: Uniform location is -1"); }
	}
	...
	void ShaderProgram::setInt(const std::string& _name, int _value) const
	{
		...
		if (glGetUniformLocation(programID, _name.c_str()) == -1) { throw std::exception("ShaderProgram::setInt: Uniform location is -1"); }
	}
	...
	void ShaderProgram::setMat4(const std::string& _name, const glm::mat4& _mat) const
	{
		...
		if (glGetUniformLocation(programID, _name.c_str()) == -1) { throw std::exception("ShaderProgram::setMat4: Uniform location is -1"); }
	}
}